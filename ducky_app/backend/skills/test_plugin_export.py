...
from backend.skills.store import export_skill_pack_to_zip, save_pack_manifest


def test_export_plugin_owned_skill_blocked(tmp_path: Path) -> None:
    with patch("backend.skills.store.plugin_owner_for_skill", return_value="materials"):
