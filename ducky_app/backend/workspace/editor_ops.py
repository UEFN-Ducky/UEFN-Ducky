...
_MUTATIONS: tuple[OpSpec, ...] = (
    ...
    _op("delete_actors", KIND_ACTOR, "exists", revertable=REVERT_NONE,
        note="named Outliner actors; not restorable"),
    ...
    _op("delete_asset", KIND_ASSET, "exists", revertable=REVERT_NONE,
        note="one unreferenced project asset; not restorable"),
    _op("delete_project_folder", KIND_ASSET, "exists", revertable=REVERT_NONE,
        note="user-asked folder unit after Lore drop; not restorable"),
