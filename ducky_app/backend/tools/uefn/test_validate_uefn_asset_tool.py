...
from backend.tools.uefn import assets_pipeline


def test_validate_uefn_asset_forwards_params():
    with patch("backend.tools.uefn.assets_pipeline.send_command") as send:
...
def test_open_asset_in_uefn_forwards_params():
    from backend.tools.uefn import assets

    with patch("backend.tools.uefn.assets.send_command") as send:
