...
def bootstrap_system_prompt(
    *,
    ...
    return (
        ...
        "Never delete island content (`delete_asset` / `delete_actors` / `delete_directory`) — "
        "fix refs / reimport / relink. Validator errors are not a delete list. "
        ...
        "list_verse_property_hashes(refresh=true) then re-inspect and retry wire ONCE. "
