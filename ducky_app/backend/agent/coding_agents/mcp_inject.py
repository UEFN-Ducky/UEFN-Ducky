...
def bootstrap_system_prompt(
    *,
    ...
    return (
        ...
        "not just mutations. Parallel editor calls (unreal__*, spawn_actor, wire_*, set_*, "
        ...
        "from your tool list, ask the user to reconnect the uefn MCP server (or restart the "
        "coding-agent chat) — do NOT tell them to toggle Toolsets off. "
