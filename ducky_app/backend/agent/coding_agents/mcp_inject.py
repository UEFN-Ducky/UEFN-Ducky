...
def bootstrap_system_prompt(
    *,
    ...
    return (
        ...
        "Nested Epic `unreal__*` tools own Verse-in-editor / entities / Creative devices / PIC. "
        "Ducky extras (materials, Niagara, assets, screenshots, prefabs, spawn_actor for props) "
        "still use the listener.\n"
