...
STORES = ("settings", "secrets", "projects", "workspace_state", "cache_docs", "plugin_kv", "chats", "ledger", "plans", "memory", "usage", "events", "mcp", "captures", "diagnostics", "digests", "automations")
