...
describe("fileDiagnosticRegistry live vs cache", () => {
  it("live errors are preserved across setScanResults all-clear cache", () => {
    ...
    // Poisoned cache saying everything is clean must not wipe live squiggle errors.
  ...
  it("mergeLiveResults ignores empty clean payloads (false empty must not wipe)", () => {
